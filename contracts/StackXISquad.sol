...
contract StackXISquad is ERC721, Ownable {
    ...
    function _buildTokenURI(uint256 tokenId) internal view returns (string memory) {
        ...
        string memory json = string.concat(
            ...
            " - ",
            playerNames[tokenId],
            '","description":"Founding squad player for STACK XI - Dallas WC matchdays on Base. Minters unlock personal video shout-outs, Farcaster tags, Decentraland lounge access, and finals whitelist perks.","image":"https://nftpepesoccer.4everbucket.com/player-',
            tokenId.toString(),
