...
const KNOCKOUT_WEEK_DAYS: ViralCalendarDay[] = [
  ...
  },
  {
    ...
    dayNumber: 3,
    date: "2026-07-06",
    dateLabel: "Sun Jul 6 · MATCHDAY LIVE",
    theme: "Cast-to-Predict",
    hook: "Every prediction = one cast. That's the viral loop.",
    matchContext: "Portugal vs Spain · 2:00 PM CT kickoff · AT&T Stadium Dallas",
    ...
    farcasterPost: [
      ...
      "I just locked mine onchain with BCC on Base.",
      "Leonardo still picks France to lift the trophy Jul 19.",
      tagsForDay(2).join(" "),
      absoluteUrl("/#predict"),
    ].join("\n"),
    xPost: "Iberian derby locked onchain. Portugal vs Spain Dallas. 🐸",
  },
  {
    id: "d4-flex",
    dayNumber: 4,
    date: "2026-07-07",
    dateLabel: "Mon Jul 7 · Winner flex",
    theme: "Meme Card Flex",
    hook: "Status loop — winners publish, losers lurk.",
    matchContext: "Portugal vs Spain result · Egypt vs Argentina Jul 7 Atlanta",
    postWindow: "9:00–10:30 AM CT",
    productAction: "Post Winner Call meme card · leaderboard screenshot",
    pepeImage: "/pepecard.jpg",
    builderTags: tagsForDay(3),
    farcasterPost: [
      "Called it on STACK XI 🐸⚽",
      "Portugal vs Spain — Dallas Round of 16 receipt on Base.",
      "Next: Egypt vs Argentina in Atlanta · Salah vs Messi.",
      tagsForDay(3).join(" "),
    ].join("\n"),
    xPost: "Dallas R16 receipt posted. Salah vs Messi next. 🐸",
  },
  {
    id: "d5-curve",
    dayNumber: 5,
  ...
  },
  {
    ...
    dayNumber: 6,
    date: "2026-07-09",
    dateLabel: "Wed Jul 9 · Builder loop",
    theme: "Honor Tags",
    hook: "Story-universe tagging — gratitude, not spam.",
    matchContext: "Culture missions · Farcaster builder arc",
    postWindow: "11:00 AM–12:30 PM CT",
    productAction: "Profile missions · follow + cast tasks",
    pepeImage: "/beforefallpepepengubeer.jpg",
    builderTags: tagsForDay(5),
    farcasterPost: [
      "Pepe doesn't chase clout — but he respects builders who ship 🐸",
      "STACK XI lore runs on Base + Farcaster energy.",
      "Tag the people who made onchain culture feel human:",
      tagsForDay(5).join(" "),
      "Team culture > solo grind.",
    ].join("\n"),
    xPost: "Builders who ship with heart > solo grind. Culture layer on Base. 🐸",
  },
  {
